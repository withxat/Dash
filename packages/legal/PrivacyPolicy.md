...
tracking, no advertising identifiers, and no third-party analytics or tracking
SDKs. The app's privacy manifest declares zero collected data types. We do not
operate a general-purpose backend that stores your account data.
