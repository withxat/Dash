...
`public/og.png` is the 1280x640 shared-link artwork used by Open Graph and X cards. Keep the important mark and copy inside the central safe area, and bump the `?v=` on both image meta tags in `index.html` whenever the artwork changes.
